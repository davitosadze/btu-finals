...
class QuestionOptionController extends Controller
{
    public function index($question_id) {
        ...
        return view("user.quizzes.questions.options.index", compact('question'));
    }

    public function add($question_id) {
        return view("user.quizzes.questions.options.add", compact('question_id'));
    ...
    public function insert(Request $req, $question_id) {
        ...
        return redirect()->route('user.quizzes.questions.options', $question_id)->with('status', 'პასუხი წარმატებით დაემატა');
    }

    public function edit($option_id) {
        $option = QuestionOption::find($option_id);
        return view("user.quizzes.questions.options.edit", compact('option'));
    }
    ...
    public function update(Request $req, $option_id) {
        ...
        return redirect()->route('user.quizzes.questions.options', $option->question_id)->with('status', 'პასუხი წარმატებით განახლდა');
